...
namespace ModernApplicationFramework.Extended.Demo.Modules.FilterDesigner.ToolboxItems
{
    ...
    {
        [Export] internal  static IToolboxItem AddItem = new ToolboxItem(new Guid("{BF8B09BC-2475-4688-9801-5605FF1D6680}") , "Add", typeof(Add), Categories.MathCategory, new []{typeof(GraphViewModel)} , Monikers.Redo);
