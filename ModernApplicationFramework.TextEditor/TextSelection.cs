...
namespace ModernApplicationFramework.TextEditor
{
    internal class TextSelection : ITextSelection
    {
        ...
        public TextSelection(ITextView wpfTextView, IEditorFormatMap editorFormatMap, GuardedOperations guardedOperations)
        {
        ...
        {
            painter?.Dispose();
            painter = BrushSelectionPainter.CreatePainter(this, SelectionAdornmentLayer, _editorFormatMap.GetProperties(category), defaultColor);
        }
            ...
            else if (Mode == TextSelectionMode.Box)
            {
                ...
                do
                {
                    ...
                    do
                    {
                        ...
                        if (containingBufferPosition.LineBreakLength != 0 || !containingBufferPosition.IsLastTextViewLineForSnapshotLine)
                        {
        ...
        private void InnerSelect(VirtualSnapshotPoint anchorPoint, VirtualSnapshotPoint activePoint)
        {
            ...
            {
                ITextViewLine containingBufferPosition1 = TextView.GetTextViewLineContainingBufferPosition(bufferPosition1.Position);
                ITextViewLine containingBufferPosition2 = TextView.GetTextViewLineContainingBufferPosition(bufferPosition2.Position);
