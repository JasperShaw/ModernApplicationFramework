...
namespace ModernApplicationFramework.TextEditor
{
    internal sealed class DefaultDisplayTextPointPrimitive : DisplayTextPoint
    {
        ...
        internal DefaultDisplayTextPointPrimitive(PrimitiveTextView textView, int position, IEditorOptions editorOptions)
        {
            TextView = textView;
            _editorOptions = editorOptions;
            _bufferPoint = TextView.TextBuffer.GetStartPoint();
            MoveTo(TextView.AdvancedTextView.TextSnapshot.CreateTrackingPoint(position, PointTrackingMode.Positive).GetPosition(TextView.TextBuffer.AdvancedTextBuffer.CurrentSnapshot));
        }

        public override PrimitiveTextView TextView { get; }

        public override ITextViewLine AdvancedTextViewLine => TextView.AdvancedTextView.GetTextViewLineContainingBufferPosition(AdvancedTextPoint);
        ...
        public override int DisplayColumn
        {
            get
            {
                ...
                return PrimitivesUtilities.GetColumnOfPoint(textView.TextSnapshot, AdvancedTextPoint, start, _editorOptions.GetTabSize(), p => textView.GetTextElementSpan(p).End);
            }
        }
        ...
        {
            if (TextView.AdvancedTextView.TextViewModel.IsPointInVisualBuffer(AdvancedTextPoint, PositionAffinity.Successor))
        ...
        public override bool DeletePrevious()
        {
            ...
            if (previousTextElementSpan.Length > 0 && TextView.AdvancedTextView.TextViewModel.IsPointInVisualBuffer(AdvancedTextPoint, PositionAffinity.Successor) && !TextView.AdvancedTextView.TextViewModel.IsPointInVisualBuffer(previousTextElementSpan.End - 1, PositionAffinity.Successor))
        ...
        public override bool TransposeCharacter()
        {
            ...
            var replacement = TextView.AdvancedTextView.TextSnapshot.GetText(textElementSpan2) + TextView.AdvancedTextView.TextSnapshot.GetText(textElementSpan1);
            return PrimitivesUtilities.Replace(TextBuffer.AdvancedTextBuffer, new Span(textElementSpan1.Start, replacement.Length), replacement);
        }
        ...
        public override SnapshotPoint AdvancedTextPoint => _bufferPoint.AdvancedTextPoint.TranslateTo(TextView.AdvancedTextView.TextSnapshot, PointTrackingMode.Positive);

        public override string GetNextCharacter()
        {
            if (CurrentPosition == TextView.AdvancedTextView.TextSnapshot.Length)
                return string.Empty;
            return TextView.AdvancedTextView.TextSnapshot.GetText(TextView.AdvancedTextView.GetTextElementSpan(AdvancedTextPoint));
        }
        ...
        {
            _bufferPoint.MoveTo(TextView.AdvancedTextView.GetTextElementSpan(new SnapshotPoint(TextView.AdvancedTextView.TextSnapshot, position)).Start);
        }
        ...
        public override void MoveToNextWord()
        {
            ...
            SnapshotSpan textElementSpan = TextView.AdvancedTextView.GetTextElementSpan(advancedTextPoint);
        ...
        {
            var containingBufferPosition = TextView.AdvancedTextView.GetTextViewLineContainingBufferPosition(AdvancedTextPoint);
