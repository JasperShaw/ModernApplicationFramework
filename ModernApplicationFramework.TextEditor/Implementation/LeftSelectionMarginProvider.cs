...
namespace ModernApplicationFramework.TextEditor.Implementation
{
    ...
    internal sealed class LeftSelectionMarginProvider : ITextViewMarginProvider
    {
        ...
        {
            return LeftSelectionMargin.Create(textViewHost, EditorOperationsFactoryService.GetEditorOperations(textViewHost.TextView), GuardedOperations, _marginState);
        }
    }
}