    ...
    internal static class SafeNativeMethods
    {
        ...
        */
        ...
        public static long GetFileSize(string path)
        {
            ...
            {
                using (
                    SafeFileHandle handle = SafeCreateFile(path, NativeFileAccess.GenericRead, FileShare.Read,
        ...
        public static IList<Win32StreamInfo> ListStreams(string filePath)
        {
            ...
            using (
                SafeFileHandle hFile = SafeCreateFile(filePath, NativeFileAccess.GenericRead, FileShare.Read,
                    ...
                    if (!hFile.IsInvalid)
                    {
                        ...
                        try
                        {
                            while (!finished)
                            {
                                ...
                                if (
                                    !BackupRead(hFile, ref streamId, dwStreamHeaderSize, out bytesRead, false, false,
                                        ref context))
                                {
                                    finished = true;
                                }
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (
                                                !BackupRead(hFile, hName.MemoryBlock, streamId.StreamNameSize,
                                        ...
                                        if (!finished
                                            && !BackupSeek(hFile, streamId.Size.Low, streamId.Size.High,
