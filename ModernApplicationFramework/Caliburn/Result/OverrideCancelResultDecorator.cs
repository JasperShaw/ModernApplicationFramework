...
{
    /// <summary>
    ///     A result decorator that overrides <see cref="ResultCompletionEventArgs.WasCancelled" /> of the decorated
    ...
    public class OverrideCancelResultDecorator : ResultDecoratorBase
    {
                                                       ...
                                                       ResultCompletionEventArgs args)
        {
            if (args.WasCancelled)
                Log.Info($"Overriding WasCancelled from {innerResult.GetType().Name}.");
