...
namespace ModernApplicationFramework.Caliburn
{
    ...
    public class SimpleContainer
    {
        ...
        readonly List<ContainerEntry> _entries;
        ...
        public IEnumerable<object> GetAllInstances(Type service)
        {
            ...
            return entry?.Select(x => x(this)) ?? new object[0];
        }
        ...
        public object GetInstance(Type service, string key)
        {
            ...
            if (DelegateType.IsAssignableFrom(service))
            {
                ...
                var factoryFactoryMethod = factoryFactoryType.GetMethod("Create", new[] {typeof (SimpleContainer)});
