...
using IWindowManager = ModernApplicationFramework.Caliburn.Platform.Xaml.IWindowManager;
using WindowManager = ModernApplicationFramework.Caliburn.Platform.Xaml.WindowManager;
using XamlPlatformProvider = ModernApplicationFramework.Caliburn.Platform.Xaml.XamlPlatformProvider;

namespace ModernApplicationFramework.Caliburn.Platform.Utilities
{
    public abstract class BootstrapperBase
    {
        readonly bool _useApplication;
        bool _isInitialized;
