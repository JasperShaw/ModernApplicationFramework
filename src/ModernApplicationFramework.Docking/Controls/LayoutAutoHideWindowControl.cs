...
namespace ModernApplicationFramework.Docking.Controls
{
    public class LayoutAutoHideWindowControl : HwndHost, ILayoutControl
    {
        ...
        internal bool IsWin32MouseOver
        {
            get
            {
                var ptMouse = new NativeMethods.NativeMethods.Point();
                if (!NativeMethods.User32.GetCursorPos(ref ptMouse))
                    return false;
        ...
        protected override HandleRef BuildWindowCore(HandleRef hwndParent)
        {
            ...
            NativeMethods.User32.BringWindowToTop(_internalHwndSource.Handle);
        ...
        protected override IntPtr WndProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            if (msg == (int)WindowsMessage.WmWindowposchanging)
            {
                if (_internalHostContentRendered)
                    NativeMethods.User32.SetWindowPos(_internalHwndSource.Handle, IntPtr.Zero, 0, 0, 0, 0, 3);
            }
