namespace ModernApplicationFramework.Text.Logic.Editor
{
    public static class DefaultOptions
    {
        ...
        public static readonly EditorOptionKey<bool> ConvertTabsToSpacesOptionId =
            new EditorOptionKey<bool>(ConvertTabsToSpacesOptionName);
        ...
        public static readonly EditorOptionKey<bool> ReplicateNewLineCharacterOptionId =
            new EditorOptionKey<bool>(ReplicateNewLineCharacterOptionName);

        public static readonly EditorOptionKey<string> NewLineCharacterOptionId =
            new EditorOptionKey<string>(NewLineCharacterOptionName);

        public static readonly EditorOptionKey<int> LongBufferLineThresholdId =
            new EditorOptionKey<int>(LongBufferLineThresholdOptionName);

        public static readonly EditorOptionKey<int> LongBufferLineChunkLengthId =
            new EditorOptionKey<int>(LongBufferLineChunkLengthOptionName);

        public static readonly EditorOptionKey<bool> TrimTrailingWhiteSpaceOptionId =
            new EditorOptionKey<bool>(TrimTrailingWhiteSpaceOptionName);

        public static readonly EditorOptionKey<bool> InsertFinalNewLineOptionId =
            new EditorOptionKey<bool>(InsertFinalNewLineOptionName);
    }
}