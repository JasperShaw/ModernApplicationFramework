...
namespace ModernApplicationFramework.Text.Data.Projection
{
    public class ProjectionSourceBuffersChangedEventArgs : ProjectionSourceSpansChangedEventArgs
    {
        ...
        public ProjectionSourceBuffersChangedEventArgs(ITextSnapshot beforeSnapshot, ITextSnapshot afterSnapshot,
            IList<ITrackingSpan> insertedSpans, IList<ITrackingSpan> deletedSpans, int spanPosition,
            IList<ITextBuffer> addedBuffers, IList<ITextBuffer> removedBuffers, EditOptions options, object editTag)
