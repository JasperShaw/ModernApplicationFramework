...
namespace ModernApplicationFramework.Text.Data
{
    public sealed class NormalizedSnapshotSpanCollection : IList<SnapshotSpan>,  IList
    {
        ...
        public NormalizedSnapshotSpanCollection(IEnumerable<SnapshotSpan> snapshotSpans)
        {
            ...
            using (var enumerator = snapshotSpans.GetEnumerator())
            {
                ...
                else
                {
                    ...
                    _spans = flag ? NormalizedSpanCollection.CreateFromNormalizedSpans(spanList) : new NormalizedSpanCollection(spanList);
                }
            }
        }
        ...
        public NormalizedSnapshotSpanCollection CloneAndTrackTo(ITextSnapshot targetSnapshot, SpanTrackingMode mode)
        {
            ...
            switch (mode)
            {
                ...
                case SpanTrackingMode.Custom:
                    ...
                    if (_spans == null)
                    {
                        var span = targetSnapshot.Version.VersionNumber > _snapshot.Version.VersionNumber ? Tracking.TrackSpanForwardInTime(mode, _span, _snapshot.Version, targetSnapshot.Version) : Tracking.TrackSpanBackwardInTime(mode, _span, _snapshot.Version, targetSnapshot.Version);
                    ...
                    for (var index = 0; index < _spans.Count; ++index)
                        spanArray[index] = targetSnapshot.Version.VersionNumber > _snapshot.Version.VersionNumber ? Tracking.TrackSpanForwardInTime(mode, _spans[index], _snapshot.Version, targetSnapshot.Version) : Tracking.TrackSpanBackwardInTime(mode, _spans[index], _snapshot.Version, targetSnapshot.Version);
        ...
        public static NormalizedSnapshotSpanCollection Union(NormalizedSnapshotSpanCollection left, NormalizedSnapshotSpanCollection right)
        {
            ...
            return new NormalizedSnapshotSpanCollection(left[0].Snapshot, NormalizedSpanCollection.Union(left1, right1));
        }
        ...
        public static NormalizedSnapshotSpanCollection Overlap(NormalizedSnapshotSpanCollection left, NormalizedSnapshotSpanCollection right)
        {
            ...
            if ((object)normalizedSpanCollection2 == null)
                normalizedSpanCollection2 = new NormalizedSpanCollection(right._span);
            var right1 = normalizedSpanCollection2;
            return new NormalizedSnapshotSpanCollection(left[0].Snapshot, NormalizedSpanCollection.Overlap(left1, right1));
        }
        ...
        public static NormalizedSnapshotSpanCollection Intersection(NormalizedSnapshotSpanCollection left, NormalizedSnapshotSpanCollection right)
        {
            ...
            if ((object)normalizedSpanCollection2 == null)
                normalizedSpanCollection2 = new NormalizedSpanCollection(right._span);
            var right1 = normalizedSpanCollection2;
            return new NormalizedSnapshotSpanCollection(left[0].Snapshot, NormalizedSpanCollection.Intersection(left1, right1));
        }
        ...
        public static NormalizedSnapshotSpanCollection Difference(NormalizedSnapshotSpanCollection left, NormalizedSnapshotSpanCollection right)
        {
            ...
            if ((object)normalizedSpanCollection2 == null)
                normalizedSpanCollection2 = new NormalizedSpanCollection(right._span);
            var right1 = normalizedSpanCollection2;
            return new NormalizedSnapshotSpanCollection(left[0].Snapshot, NormalizedSpanCollection.Difference(left1, right1));
        }
