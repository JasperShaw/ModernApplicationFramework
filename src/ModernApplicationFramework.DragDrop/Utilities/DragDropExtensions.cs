...
namespace ModernApplicationFramework.DragDrop.Utilities
{
    ...
    {
        /// <summary>
        /// Determines whether the given element is ignored on drag start (<see cref="ModernApplicationFramework.DragDrop.DragSourceIgnore"/>).
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the given element is ignored on drop action (<see cref="ModernApplicationFramework.DragDrop.IsDragSource"/>).
        /// </summary>
        /// <param name="element">The given element.</param>
        /// <returns>Element is ignored or not.</returns>
        ...
        /// <summary>
        /// Determines whether the given element is ignored on drop action (<see cref="ModernApplicationFramework.DragDrop.IsDropTarget"/>).
        /// </summary>
        /// <param name="element">The given element.</param>
        /// <returns>Element is ignored or not.</returns>
