    ...
    internal class WpfMouseProcessor : IDisposable
    {
        ...
        protected WpfMouseProcessor(UIElement element, GuardedOperations guardedOperations, FrameworkElement manipulationElement)
        {
            ...
            if (manipulationElement != null)
            {
                ...
                ManipulationElement.AddHandler(UIElement.ManipulationInertiaStartingEvent, new EventHandler<ManipulationInertiaStartingEventArgs>(UIElement_ManipulationInertiaStarting), true);
                ManipulationElement.AddHandler(UIElement.ManipulationStartingEvent, new EventHandler<ManipulationStartingEventArgs>(UIElement_ManipulationStarting), true);
                ManipulationElement.AddHandler(UIElement.ManipulationCompletedEvent, new EventHandler<ManipulationCompletedEventArgs>(UIElement_ManipulationCompleted), true);
                ManipulationElement.AddHandler(UIElement.ManipulationDeltaEvent, new EventHandler<ManipulationDeltaEventArgs>(UIElement_ManipulationDelta), true);
                ManipulationElement.AddHandler(UIElement.TouchDownEvent, new EventHandler<TouchEventArgs>(UIElement_TouchDown), true);
                ManipulationElement.AddHandler(UIElement.TouchUpEvent, new EventHandler<TouchEventArgs>(UIElement_TouchUp), true);
                ManipulationElement.AddHandler(UIElement.StylusSystemGestureEvent, new StylusSystemGestureEventHandler(UIElement_StylusSystemGesture), true);
            }
            Element.AddHandler(UIElement.MouseLeftButtonDownEvent, new MouseButtonEventHandler(UIElement_MouseLeftButtonDown), true);
            Element.AddHandler(UIElement.MouseLeftButtonUpEvent, new MouseButtonEventHandler(UIElement_MouseLeftButtonUp), true);
            Element.AddHandler(UIElement.MouseRightButtonDownEvent, new MouseButtonEventHandler(UIElement_MouseRightButtonDown), true);
            Element.AddHandler(UIElement.MouseRightButtonUpEvent, new MouseButtonEventHandler(UIElement_MouseRightButtonUp), true);
            ...
            Element.AddHandler(UIElement.QueryContinueDragEvent, new QueryContinueDragEventHandler(UIElement_QueryContinueDrag), true);
        }
        ...
        {
            if (!Element.Focusable || (e.Handled || Element.IsKeyboardFocused) && (!e.Handled || Element.IsKeyboardFocusWithin))
                return false;
        ...
        {
            MouseProcessorHandler(e, p => p.PreprocessMouseWheel(e), () => DefaultMouseWheelHandler(sender, e), p => p.PostprocessMouseWheel(e));
        }
        ...
        public void UIElement_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            MouseProcessorHandler(e, p => p.PreprocessMouseLeftButtonDown(e), () => DefaultMouseLeftButtonDownHandler(sender, e), p => p.PostprocessMouseLeftButtonDown(e));
        ...
        public void UIElement_MouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            MouseProcessorHandler(e, p => p.PreprocessMouseDown(e), () => DefaultMouseDownHandler(sender, e), p => p.PostprocessMouseDown(e));
            e.Handled |= flag;
        }

        public void UIElement_MouseUp(object sender, MouseButtonEventArgs e)
        {
            MouseProcessorHandler(e, p => p.PreprocessMouseUp(e), () => DefaultMouseUpHandler(sender, e), p => p.PostprocessMouseUp(e));
        }

        public void UIElement_MouseMove(object sender, MouseEventArgs e)
        {
            MouseProcessorHandler(e, p => p.PreprocessMouseMove(e), () => DefaultMouseMoveHandler(sender, e), p => p.PostprocessMouseMove(e));
        }
        ...
        {
            MouseProcessorHandler(e, p => p.PreprocessMouseLeave(e), () => DefaultMouseLeaveHandler(sender, e), p => p.PostprocessMouseLeave(e));
        }

        public void UIElement_MouseEnter(object sender, MouseEventArgs e)
        {
            MouseProcessorHandler(e, p => p.PreprocessMouseEnter(e), () => DefaultMouseEnterHandler(sender, e), p => p.PostprocessMouseEnter(e));
        }

        public void UIElement_MouseRightButtonUp(object sender, MouseButtonEventArgs e)
        {
            MouseProcessorHandler(e, p => p.PreprocessMouseRightButtonUp(e), () => DefaultMouseRightButtonUpHandler(sender, e), p => p.PostprocessMouseRightButtonUp(e));
        }

        public void UIElement_MouseRightButtonDown(object sender, MouseButtonEventArgs e)
        {
            var focusFromMouseEvent = TakeFocusFromMouseEvent(e);
            MouseProcessorHandler(e, p => p.PreprocessMouseRightButtonDown(e), () => DefaultMouseRightButtonDownHandler(sender, e), p => p.PostprocessMouseRightButtonDown(e));
            e.Handled |= focusFromMouseEvent;
        }

        public void UIElement_Drop(object sender, DragEventArgs e)
        {
            MouseProcessorHandler(e, p => p.PreprocessDrop(e), () => DefaultDropHandler(sender, e), p => p.PostprocessDrop(e));
        }

        public void UIElement_DragOver(object sender, DragEventArgs e)
        {
            MouseProcessorHandler(e, p => p.PreprocessDragOver(e), () => DefaultDragOverHandler(sender, e), p => p.PostprocessDragOver(e));
        }

        public void UIElement_DragLeave(object sender, DragEventArgs e)
        {
            MouseProcessorHandler(e, p => p.PreprocessDragLeave(e), () => DefaultDragLeaveHandler(sender, e), p => p.PostprocessDragLeave(e));
        }

        public void UIElement_DragEnter(object sender, DragEventArgs e)
        {
            MouseProcessorHandler(e, p => p.PreprocessDragEnter(e), () => DefaultDragEnterHandler(sender, e), p => p.PostprocessDragEnter(e));
        }

        public void UIElement_QueryContinueDrag(object sender, QueryContinueDragEventArgs e)
        {
            MouseProcessorHandler(e, p => p.PreprocessQueryContinueDrag(e), () => DefaultQueryContinueDragHandler(sender, e), p => p.PostprocessQueryContinueDrag(e));
        }

        public void UIElement_GiveFeedback(object sender, GiveFeedbackEventArgs e)
        {
            MouseProcessor2Handler(e, p => p.PreprocessGiveFeedback(e), () => DefaultGiveFeedbackHandler(sender, e), p => p.PostprocessGiveFeedback(e));
        }

        public void UIElement_ManipulationInertiaStarting(object sender, ManipulationInertiaStartingEventArgs e)
        {
            MouseProcessor2Handler(e, p => p.PreprocessManipulationInertiaStarting(e), () => DefaultManipulationInertiaStartingHandler(sender, e), p => p.PostprocessManipulationInertiaStarting(e));
        }

        public void UIElement_ManipulationStarting(object sender, ManipulationStartingEventArgs e)
        {
            MouseProcessor2Handler(e, p => p.PreprocessManipulationStarting(e), () => DefaultManipulationStartingHandler(sender, e), p => p.PostprocessManipulationStarting(e));
        }

        public void UIElement_ManipulationCompleted(object sender, ManipulationCompletedEventArgs e)
        {
            MouseProcessor2Handler(e, p => p.PreprocessManipulationCompleted(e), () => DefaultManipulationCompletedHandler(sender, e), p => p.PostprocessManipulationCompleted(e));
        }

        public void UIElement_ManipulationDelta(object sender, ManipulationDeltaEventArgs e)
        {
            MouseProcessor2Handler(e, p => p.PreprocessManipulationDelta(e), () => DefaultManipulationDeltaHandler(sender, e), p => p.PostprocessManipulationDelta(e));
        }

        public void UIElement_TouchDown(object sender, TouchEventArgs e)
        {
            MouseProcessor2Handler(e, p => p.PreprocessTouchDown(e), () => DefaultTouchDownHandler(sender, e), p => p.PostprocessTouchDown(e));
        }

        public void UIElement_TouchUp(object sender, TouchEventArgs e)
        {
            MouseProcessor2Handler(e, p => p.PreprocessTouchUp(e), () => DefaultTouchDownHandler(sender, e), p => p.PostprocessTouchUp(e));
        }

        public void UIElement_StylusSystemGesture(object sender, StylusSystemGestureEventArgs e)
        {
            MouseProcessor2Handler(e, p => p.PreprocessStylusSystemGesture(e), () => DefaultStylusSystemGestureHandler(sender, e), p => p.PostprocessStylusSystemGesture(e));
        }
