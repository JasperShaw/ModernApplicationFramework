...
namespace ModernApplicationFramework.Modules.Editor.Utilities
{
    internal class ContentType : IContentType
    {
        ...
        internal static ContentType AddContentTypeFromMetadata(string contentTypeName, string mimeType,
            ...
            IDictionary<string, ContentType> nameToContentTypeBuilder,
            IDictionary<string, ContentType> mimeTypeToContentTypeBuilder)
        {
            if (string.IsNullOrEmpty(contentTypeName))
                return null;
            if (!nameToContentTypeBuilder.TryGetValue(contentTypeName, out var contentTypeImpl))
            {
                var flag = false;
        ...
        internal void ProcessBaseTypes(IDictionary<string, ContentType> nameToContentTypeBuilder,
            IDictionary<string, ContentType> mimeTypeToContentTypeBuilder)
        {
