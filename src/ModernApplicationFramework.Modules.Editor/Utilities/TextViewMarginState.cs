...
namespace ModernApplicationFramework.Modules.Editor.Utilities
{
    ...
    {
        internal ImmutableDictionary<string, List<Lazy<ITextViewMarginProvider, ITextViewMarginMetadata>>> MarginMap =
            ImmutableDictionary<string, List<Lazy<ITextViewMarginProvider, ITextViewMarginMetadata>>>.Empty
                .WithComparers(StringComparer.OrdinalIgnoreCase);

        public IList<Lazy<ITextViewMarginProvider, ITextViewMarginMetadata>> OrderedMarginProviders { get; set; }

        [ImportMany] internal List<Lazy<ITextViewMarginProvider, ITextViewMarginMetadata>> MarginProviders { get; set; }

        public IReadOnlyList<Lazy<ITextViewMarginProvider, ITextViewMarginMetadata>> GetMarginProviders(
            string containerName)
        {
            ...
            {
                marginProviders = OrderedMarginProviders.Where(orderedMarginProvider =>
                    StringComparer.OrdinalIgnoreCase.Equals(orderedMarginProvider.Metadata.MarginContainer,
