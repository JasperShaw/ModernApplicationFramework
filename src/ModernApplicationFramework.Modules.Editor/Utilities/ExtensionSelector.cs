...
namespace ModernApplicationFramework.Modules.Editor.Utilities
{
    internal static class ExtensionSelector
    {
        ...
        public static bool ContentTypeMatch(IEnumerable<IContentType> dataContentTypes,
        ...
        public static List<Lazy<TProvider, TMetadataView>> SelectMatchingExtensions<TProvider, TMetadataView>(
            IEnumerable<Lazy<TProvider, TMetadataView>> providerHandles, IContentType dataContentType)
