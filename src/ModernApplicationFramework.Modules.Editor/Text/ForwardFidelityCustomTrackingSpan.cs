...
namespace ModernApplicationFramework.Modules.Editor.Text
{
    internal sealed class ForwardFidelityCustomTrackingSpan : ForwardFidelityTrackingSpan
    {
        ...
        public ForwardFidelityCustomTrackingSpan(ITextVersion version, Span span, object customState,
        ...
        protected override Span TrackSpanBackwardInTime(Span span, ITextVersion currentVersion,
            ITextVersion targetVersion)
        {
            return _behavior(this, currentVersion, targetVersion, span, _customState);
        }

        protected override Span TrackSpanForwardInTime(Span span, ITextVersion currentVersion,
            ITextVersion targetVersion)
        {
            return _behavior(this, currentVersion, targetVersion, span, _customState);
        }
