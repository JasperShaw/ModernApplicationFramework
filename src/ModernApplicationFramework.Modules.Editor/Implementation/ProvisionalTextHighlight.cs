...
namespace ModernApplicationFramework.Modules.Editor.Implementation
{
    internal sealed class ProvisionalTextHighlight
    {
        ...
        public ProvisionalTextHighlight(ITextView wpfTextView)
        {
            ...
            var color2 = Color.FromArgb(180, (byte) (highlightColor.R / 3U), (byte) (highlightColor.G / 3U),
                (byte) (highlightColor.B / 3U));
            ...
            _blinkTimer = new DispatcherTimer(new TimeSpan(0, 0, 0, 0, caretBlinkTime), DispatcherPriority.Normal,
                OnTimerElapsed, _wpfTextView.VisualElement.Dispatcher);
        }
        ...
        private void Repaint()
        {
            if (_provisionalSpan == null)
                return;
            ClearAdornment();
            var textMarkerGeometry =
                _wpfTextView.TextViewLines.GetTextMarkerGeometry(_provisionalSpan.GetSpan(_wpfTextView.TextSnapshot));
            ...
            if (_highlightAdornment == null)
                return;
            _adornmentLayer.AddAdornment(_provisionalSpan.GetSpan(_wpfTextView.TextSnapshot), this,
                _highlightAdornment);
        }
    }
}