...
namespace ModernApplicationFramework.Modules.Editor.Implementation
{
    internal sealed class KeyProcessorDispatcher
    {
        ...
        internal KeyProcessorDispatcher(ITextView textView, List<KeyProcessor> keyProcessors, GuardedOperations guardedOperations)
        {
        ...
        private void DispatchTextInputEvents(FrameworkElement element)
        {
            ...
            TextCompositionManager.AddPreviewTextInputStartHandler(element, MakeHandler((p, args) => p.PreviewTextInputStart(args)));
            TextCompositionManager.AddTextInputUpdateHandler(element, MakeHandler((p, args) => p.TextInputUpdate(args)));
            TextCompositionManager.AddPreviewTextInputUpdateHandler(element, MakeHandler((p, args) => p.PreviewTextInputUpdate(args)));
        }
