...
namespace ModernApplicationFramework.Modules.Editor.NativeMethods
{
    internal class User32
    {
        ...
        public static extern IntPtr LoadImage(IntPtr hinst, string lpszName, NativeMethods.ImageType uType,
            int cxDesired, int cyDesired, NativeMethods.ImageFormatRequest fuLoad);
