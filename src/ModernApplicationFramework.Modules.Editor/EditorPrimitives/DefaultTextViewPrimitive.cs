...
namespace ModernApplicationFramework.Modules.Editor.EditorPrimitives
{
    internal sealed class DefaultTextViewPrimitive : PrimitiveTextView
    {
        ...
        public override DisplayTextRange VisibleSpan => GetTextRange(
            AdvancedTextView.TextViewLines.FirstVisibleLine.Start,
            AdvancedTextView.TextViewLines.LastVisibleLine.EndIncludingLineBreak);

        internal DefaultTextViewPrimitive(ITextView textView, IViewPrimitivesFactoryService viewPrimitivesFactory,
        ...
        {
            AdvancedTextView.DisplayTextLineContainingBufferPosition(
                AdvancedTextView.TextBuffer.CurrentSnapshot.GetLineFromLineNumber(lineNumber).Start, 0.0,
        ...
        {
            AdvancedTextView.ViewScroller.ScrollViewportVerticallyByPixels(
                -(double) lines * AdvancedTextView.LineHeight);
        }
        ...
        public override bool Show(DisplayTextPoint point, HowToShow howToShow)
        {
            ...
            {
                case HowToShow.AsIs:
                    AdvancedTextView.ViewScroller.EnsureSpanVisible(new SnapshotSpan(point.AdvancedTextPoint, 0),
                ...
                case HowToShow.OnFirstLineOfView:
                    AdvancedTextView.DisplayTextLineContainingBufferPosition(point.AdvancedTextPoint, 0.0,
                        ViewRelativePosition.Top);
                    break;
            }
        ...
        public override VisibilityState Show(DisplayTextRange textRange, HowToShow howToShow)
        {
            ...
            {
                case HowToShow.AsIs:
                    AdvancedTextView.ViewScroller.EnsureSpanVisible(textRange.AdvancedTextRange,
                        EnsureSpanVisibleOptions.MinimumScroll);
                    break;
                case HowToShow.Centered:
                    AdvancedTextView.ViewScroller.EnsureSpanVisible(textRange.AdvancedTextRange,
                    ...
                    break;
                case HowToShow.OnFirstLineOfView:
                    AdvancedTextView.DisplayTextLineContainingBufferPosition(textRange.AdvancedTextRange.Start, 0.0,
                        ViewRelativePosition.Top);
                    break;
            }
