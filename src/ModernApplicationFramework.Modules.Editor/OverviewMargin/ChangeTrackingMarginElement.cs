...
namespace ModernApplicationFramework.Modules.Editor.OverviewMargin
{
    internal class ChangeTrackingMarginElement : FrameworkElement
    {
        ...
        public ChangeTrackingMarginElement(ITextView textView, IVerticalScrollBar verticalScrollbar, OverviewChangeTrackingMarginProvider provider)
        {
            _textView = textView;
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            if (ChangeTagAggregator == null)
                return;
            var unifiedChanges = GetUnifiedChanges(_textView.TextSnapshot, ChangeTagAggregator.GetTags(new SnapshotSpan(_textView.TextSnapshot, 0, _textView.TextSnapshot.Length)));
        ...
        private void DrawChange(DrawingContext drawingContext, ChangeTypes type, IReadOnlyList<NormalizedSnapshotSpanCollection> allChanges)
        {
            ...
            for (var index = 1; index < allChange.Count; ++index)
            {
                ...
                {
                    drawingContext.DrawRectangle(_brushes[(int)type], null, new Rect(1.0, yTop1, Width - 1.0, yBottom1 - yTop1));
                    yTop1 = yTop2;
                }
                yBottom1 = yBottom2;
            }
