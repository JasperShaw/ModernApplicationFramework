...
using ModernApplicationFramework.Input.NativeMethods;
using ModernApplicationFramework.Input.Resources;
...
namespace ModernApplicationFramework.Input
{
    public static class KeyboardLocalizationUtilities
    {
        ...
        private static string GetSingleCultureModifierName(ModifierKeys modifier, CultureInfo culture = null)
        {
            switch (modifier)
            {
