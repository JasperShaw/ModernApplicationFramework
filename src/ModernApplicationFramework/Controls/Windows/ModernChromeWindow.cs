...
using Gdi32 = ModernApplicationFramework.Native.NativeMethods.Gdi32;
using Point = System.Windows.Point;
using RECT = ModernApplicationFramework.Native.Platform.Structs.RECT;
using User32 = ModernApplicationFramework.Native.NativeMethods.User32;
...
namespace ModernApplicationFramework.Controls.Windows
{
    ...
    public class ModernChromeWindow : Window
    {
        ...
        {
            return _glowWindows[direction] ?? (_glowWindows[direction] = new GlowWindow(this, (Dock) direction, isSubclass)
            {
        ...
        private class SuppressRedrawScope : IDisposable
        {
            ...
            {
                _hwnd = hwnd;
                if ((User32.GetWindowLong(hwnd, (int) Gwl.Style) & 268435456) == 0)
                    return;
                SetRedraw(false);
            ...
            {
                User32.SendMessage(_hwnd, 11, new IntPtr(Convert.ToInt32(state)), IntPtr.Zero);
            }
        }
        ...
        private sealed class GlowWindow : HwndWrapper
        {
            ...
            public GlowWindow(ModernChromeWindow owner, Dock orientation, bool isWindowSubclass)
            {
            ...
            private void UpdateProperty<T>(ref T field, T value,
                FieldInvalidationTypes invalidatedValues) where T : struct
            {
            ...
            {
                get => _left;
                set => UpdateProperty(ref _left, value,
                    FieldInvalidationTypes.Location);
            }

            private int Top
            {
                get => _top;
                set => UpdateProperty(ref _top, value,
                    FieldInvalidationTypes.Location);
            }
            ...
            public bool IsActive
            {
                ...
                set => UpdateProperty(ref _isActive, value,
                    FieldInvalidationTypes.Render);
            }
            ...
            public Color ActiveGlowColor
            {
                ...
                set => UpdateProperty(ref _activeGlowColor, value,
                    FieldInvalidationTypes.ActiveColor |
                    FieldInvalidationTypes.Render);
            }
            ...
            public Color InactiveGlowColor
            {
                ...
                set => UpdateProperty(ref _inactiveGlowColor, value,
                    FieldInvalidationTypes.InactiveColor |
                    FieldInvalidationTypes.Render);
            }
            ...
            {
                return User32.CreateWindowEx(524416,
                    new IntPtr(WindowClassAtom), string.Empty, -2046820352, 0, 0, 0, 0,
            ...
            protected override IntPtr WndProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam)
            {
                switch (msg)
                {
                    ...
                    case 173:
                        ...
                        User32.SendMessage(targetWindowHandle, 6,
                            new IntPtr(2), IntPtr.Zero);
                        User32.SendMessage(targetWindowHandle, msg, wParam,
                            IntPtr.Zero);
                        return IntPtr.Zero;
                }
            ...
            private void UpdateWindowPosCore()
            {
                ...
                if (!InvalidatedValuesHasFlag(FieldInvalidationTypes.Size))
                    flags |= 1;
                User32.SetWindowPos(Handle, IntPtr.Zero, Left,
            ...
            private void RenderLayeredWindow()
            {
                using (var drawingContext =
                    new GlowDrawingContext(Width, Height))
                {
                    ...
                    var pptSrc = new Native.Platform.Structs.Point
                    {
                        X = 0,
                        Y = 0
                    };
                    User32.UpdateLayeredWindow(Handle,
                        drawingContext.ScreenDc, ref pptDest, ref psize, drawingContext.WindowDc, ref pptSrc, 0U,
                        ref drawingContext.Blend, 2U);
                }
            }

            private GlowBitmap GetOrCreateBitmap(
                GlowDrawingContext drawingContext, GlowBitmapPart bitmapPart)
            {
            ...
            {
                var bitmap1 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.CornerTopLeft);
                var bitmap2 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.LeftTop);
                var bitmap3 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.Left);
                var bitmap4 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.LeftBottom);
                var bitmap5 = GetOrCreateBitmap(drawingContext,
                    GlowBitmapPart.CornerBottomLeft);
                ...
                Gdi32.SelectObject(drawingContext.BackgroundDc,
                    bitmap1.Handle);
                Msimg32.AlphaBlend(drawingContext.WindowDc, 0, 0, bitmap1.Width,
                    bitmap1.Height, drawingContext.BackgroundDc, 0, 0, bitmap1.Width, bitmap1.Height,
                    drawingContext.Blend);
                Gdi32.SelectObject(drawingContext.BackgroundDc,
                    bitmap2.Handle);
                Msimg32.AlphaBlend(drawingContext.WindowDc, 0, height,
                    bitmap2.Width, bitmap2.Height, drawingContext.BackgroundDc, 0, 0, bitmap2.Width, bitmap2.Height,
                    drawingContext.Blend);
                if (hDest > 0)
                {
                    Gdi32.SelectObject(drawingContext.BackgroundDc,
                        bitmap3.Handle);
                    Msimg32.AlphaBlend(drawingContext.WindowDc, 0, yoriginDest1,
                        bitmap3.Width, hDest, drawingContext.BackgroundDc, 0, 0, bitmap3.Width, bitmap3.Height,
                        drawingContext.Blend);
                }

                Gdi32.SelectObject(drawingContext.BackgroundDc,
                    bitmap4.Handle);
                Msimg32.AlphaBlend(drawingContext.WindowDc, 0, yoriginDest3,
                    bitmap4.Width, bitmap4.Height, drawingContext.BackgroundDc, 0, 0, bitmap4.Width, bitmap4.Height,
                    drawingContext.Blend);
                Gdi32.SelectObject(drawingContext.BackgroundDc,
                    bitmap5.Handle);
                Msimg32.AlphaBlend(drawingContext.WindowDc, 0, yoriginDest2,
                    bitmap5.Width, bitmap5.Height, drawingContext.BackgroundDc, 0, 0, bitmap5.Width, bitmap5.Height,
                    drawingContext.Blend);
            }
            ...
            {
                var bitmap1 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.CornerTopRight);
                var bitmap2 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.RightTop);
                var bitmap3 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.Right);
                var bitmap4 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.RightBottom);
                var bitmap5 = GetOrCreateBitmap(drawingContext,
                    GlowBitmapPart.CornerBottomRight);
                var height = bitmap1.Height;
                var yoriginDest1 = height + bitmap2.Height;
                var yoriginDest2 = drawingContext.Height - bitmap5.Height;
                var yoriginDest3 = yoriginDest2 - bitmap4.Height;
            ...
            {
                var bitmap1 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.TopLeft);
                var bitmap2 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.Top);
                var bitmap3 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.TopRight);
                var xoriginDest1 = 9;
                ...
                Gdi32.SelectObject(drawingContext.BackgroundDc,
                    bitmap1.Handle);
                Msimg32.AlphaBlend(drawingContext.WindowDc, xoriginDest1, 0,
                    bitmap1.Width, bitmap1.Height, drawingContext.BackgroundDc, 0, 0, bitmap1.Width, bitmap1.Height,
                    drawingContext.Blend);
                if (wDest > 0)
                {
                    Gdi32.SelectObject(drawingContext.BackgroundDc,
                        bitmap2.Handle);
                    Msimg32.AlphaBlend(drawingContext.WindowDc, xoriginDest2, 0,
                        wDest, bitmap2.Height, drawingContext.BackgroundDc, 0, 0, bitmap2.Width, bitmap2.Height,
                        drawingContext.Blend);
                }

                Gdi32.SelectObject(drawingContext.BackgroundDc,
                    bitmap3.Handle);
                Msimg32.AlphaBlend(drawingContext.WindowDc, xoriginDest3, 0,
                    bitmap3.Width, bitmap3.Height, drawingContext.BackgroundDc, 0, 0, bitmap3.Width, bitmap3.Height,
                    drawingContext.Blend);
            }
            ...
            {
                var bitmap1 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.BottomLeft);
                var bitmap2 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.Bottom);
                var bitmap3 =
                    GetOrCreateBitmap(drawingContext, GlowBitmapPart.BottomRight);
                var xoriginDest1 = 9;
                var xoriginDest2 = xoriginDest1 + bitmap1.Width;
                var xoriginDest3 = drawingContext.Width - 9 - bitmap3.Width;
                var wDest = xoriginDest3 - xoriginDest2;
            ...
            public void UpdateWindowPos()
            {
                ...
                User32.GetWindowPlacement(targetWindowHandle, new Windowplacement());
                if (!IsVisible)
                    return;
                switch (_orientation)
                {
