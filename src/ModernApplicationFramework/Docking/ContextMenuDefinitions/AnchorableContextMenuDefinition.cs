...
namespace ModernApplicationFramework.Docking.ContextMenuDefinitions
{
    public class AnchorableContextMenuDefinition
    {
        ...
        [Export] public static CommandBarItemDataSource DockCommandItem =
            new CommandBarCommandItemDataSource<DockWindowCommandDefinition>(new Guid("{41C19548-2E82-4ACD-AE21-6097B811B9F2}"), AnchorableContextMenuGroup, 1);

        [Export] public static CommandBarItemDataSource DockAsTabbedCommandItem =
            new CommandBarCommandItemDataSource<DockAsTabbedDocumentCommandDefinition>(new Guid("{9B0C7432-5B92-4982-ADB3-2D27A1A5817C}"), AnchorableContextMenuGroup, 2);

        [Export] public static CommandBarItemDataSource AutoHideWindowCommandItem =
            new CommandBarCommandItemDataSource<AutoHideWindowCommandDefinition>(new Guid("{7F7181B2-BECE-4589-A347-13D3C539A58E}"), AnchorableContextMenuGroup, 3);

        [Export] public static CommandBarItemDataSource HideCommandItem =
            new CommandBarCommandItemDataSource<HideDockedWindowCommandDefinition>(new Guid("{F074C243-8AE2-49EF-AF3B-D4334BDC73C4}"), AnchorableContextMenuGroup, 4);
    }
}