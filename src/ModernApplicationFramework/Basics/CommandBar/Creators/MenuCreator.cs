...
namespace ModernApplicationFramework.Basics.CommandBar.Creators
{
    ...
    {
        public MenuItem CreateMenuItem(CommandBarDataSource contextMenuDefinition, IReadOnlyList<CommandBarGroup> groups, Func<CommandBarGroup, IReadOnlyList<CommandBarItemDataSource>> itemsFunc)
        {
