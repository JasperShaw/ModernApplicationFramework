...
namespace ModernApplicationFramework.Basics.WindowModels
{
    ...
    /// <summary>
    /// View model for a <see cref="Window"/> that is an instance of <see cref="Conductor{T}"/> where T is <see langowrd="object"/>
    /// </summary>
    /// <seealso cref="Conductor{T}" />
    /// <seealso cref="T:ModernApplicationFramework.Interfaces.ViewModels.IWindowViewModel" />
    public class WindowViewModelConductor : Conductor<object>, IWindowViewModel, IPartImportsSatisfiedNotification
    {
