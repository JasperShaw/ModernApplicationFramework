...
namespace ModernApplicationFramework.Basics.WindowModels
{
    ...
    /// <summary>
    /// View model for a <see cref="Window"/> that is an instance of <see cref="Conductor{T}.Collection.OneActive"/> where T is <see langowrd="object"/>
    /// </summary>
    ...
    public class WindowViewModelConductorOneActive : Conductor<object>.Collection.OneActive, IWindowViewModel, IPartImportsSatisfiedNotification
    {
