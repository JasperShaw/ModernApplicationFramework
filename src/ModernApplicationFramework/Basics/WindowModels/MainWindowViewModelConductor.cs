...
namespace ModernApplicationFramework.Basics.WindowModels
{
    ...
    /// <summary>
    /// View model for a <see cref="MainWindow"/> that is an instance of <see cref="Conductor{T}"/> where T is <see langword="object"/>
    /// </summary>
    /// <seealso cref="Conductor{T}" />
    /// <seealso cref="T:ModernApplicationFramework.Interfaces.ViewModels.IMainWindowViewModel" />
    public class MainWindowViewModelConductor : WindowViewModelConductor, IMainWindowViewModel
    {
