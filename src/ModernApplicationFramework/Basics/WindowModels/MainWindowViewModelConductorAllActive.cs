...
namespace ModernApplicationFramework.Basics.WindowModels
{
    ...
    /// <summary>
    /// View model for a <see cref="MainWindow"/> that is an instance of <see cref="Conductor{T}.Collection.AllActive"/> where T is <see langword="object"/>
    /// </summary>
    ...
    public class MainWindowViewModelConductorAllActive : WindowViewModelConductorAllActive, IMainWindowViewModel
    {
