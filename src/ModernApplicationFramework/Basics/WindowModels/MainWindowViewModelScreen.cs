...
namespace ModernApplicationFramework.Basics.WindowModels
{
    ...
    /// <summary>
    /// View model for a <see cref="MainWindow"/> that is an instance of <see cref="Screen"/>
    /// </summary>
    /// <seealso cref="Screen" />
    /// <seealso cref="T:ModernApplicationFramework.Interfaces.ViewModels.IMainWindowViewModel" />
    public class MainWindowViewModelScreen : WindowViewModelScreen, IMainWindowViewModel
    {
