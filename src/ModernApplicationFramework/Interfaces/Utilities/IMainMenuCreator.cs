...
namespace ModernApplicationFramework.Interfaces.Utilities
{
    ...
    public interface IMainMenuCreator : ICreatorBase
    {
        ...
        MenuItem CreateMenuItem(CommandBarDataSource contextMenuDefinition, IReadOnlyList<CommandBarGroup> groups, Func<CommandBarGroup, IReadOnlyList<CommandBarItemDataSource>> itemsFunc);
    }
}