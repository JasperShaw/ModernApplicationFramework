...
namespace ModernApplicationFramework.Interfaces.Utilities
{
    ...
    public interface IContextMenuCreator : ICreatorBase
    {
        ...
        ContextMenu CreateContextMenu(CommandBarDataSource contextMenuDefinition, IReadOnlyList<CommandBarGroupDefinition> groups, Func<CommandBarGroupDefinition, IReadOnlyList<CommandBarItemDataSource>> itemsFunc);
    }
}
