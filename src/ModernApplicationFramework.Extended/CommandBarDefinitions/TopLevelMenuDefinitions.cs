...
namespace ModernApplicationFramework.Extended.CommandBarDefinitions
{
    ...
    {
        [Export]
        public static CommandBarItemDefinition FileMenu =
        ...
        [Export]
        public static CommandBarItemDefinition ViewMenu =
        ...
        [Export]
        public static CommandBarItemDefinition ToolsMenu =
        ...
        [Export]
        public static CommandBarItemDefinition WindowMenu =
            new MenuDefinition(new Guid("{A825AD90-0657-45B0-BCA1-1BC8137512BE}"),
