...
namespace ModernApplicationFramework.Threading
{
    internal static class Dgml
    {
        ...
        {
            Validate.IsNotNull(document, nameof(document));
        ...
        {
            Validate.IsNotNull(document, nameof(document));
            Validate.IsNotNullAndNotEmpty(elementName, nameof(elementName));
        ...
        {
           Validate.IsNotNull(document, nameof(document));
            Validate.IsNotNull(categories, nameof(categories));
        ...
        {
            Validate.IsNotNullAndNotEmpty(source, nameof(source));
            Validate.IsNotNullAndNotEmpty(target, nameof(target));
        ...
        {
            Validate.IsNotNull(document, nameof(document));
            Validate.IsNotNull(link, nameof(link));
        ...
        {
            Validate.IsNotNullAndNotEmpty(id, nameof(id));
        ...
        {
            Validate.IsNotNull(node, nameof(node));
            Validate.IsNotNull(container, nameof(container));
        ...
        {
            Validate.IsNotNull(node, nameof(node));
            Validate.IsNotNullAndNotEmpty(containerId, nameof(containerId));
        ...
        {
            Validate.IsNotNull(document, nameof(document));
            Validate.IsNotNullAndNotEmpty(categoryId, nameof(categoryId));
            Validate.IsNotNull(properties, nameof(properties));
            Validate.IsNotNullAndNotEmpty(targetType, nameof(targetType));
